...
void main() {
  group("ReviewRemoteDataSource.submitReview", () {
    ...
    test(
      "POSTs {baseUrl}/v1/places/{placeType}/{placeId}/reviews with the "
      "rating/comment body and parses a 201 response",
      () async {
        Uri? capturedUri;
    ...
    test("throws ReviewRequestFailure when the network call itself fails", () async {
