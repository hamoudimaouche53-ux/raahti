...
import "package:rahati/features/map_discovery/domain/entities/place.dart" show PlaceKind;
...
void main() {
  group("RestReviewRepository", () {
    ...
    test(
      "submitReview maps PlaceKind.thirdPartyPlace to the hyphenated wire "
      "value and returns the mapped Review",
      () async {
        Uri? capturedUri;
        ...
        expect(
          capturedUri,
          Uri.parse("https://api.raahti.dz/v1/places/third-party-place/p1/reviews"),
        );
        expect(review.id, "r1");
